...
#ifdef MAC_KIT
//********************************************************************************
//	The Great Malloc Issue - Using malloc in a program which uses the Mac toolbox
//	can really screw things up. Malloc works by grabbing a chunk of memory from
//	the system and calling free() doesn't give it back to the system. It only marks
//	it as free in mallocs records.
//	So anyway. For the purposes of this code and since there doesn't seem to be any
//	elaborate error handling going on, I suspect I can get away with just changing 
//	the function names.					// FG - 11/6/97
//********************************************************************************
#ifdef __MWERKS__
    // lets use malloc and free under ProjectBuilder (OS X), there is probably
    // a better way to ifdef this. pc
...
/********************************************************************/
int
MatMult(double *aptr, int nrow, int pcol, double *bptr, int prow, int ncol, 
		double *outptr)
/********************************************************************/
{
