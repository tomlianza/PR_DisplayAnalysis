...
#if 0 // Not yet implemented (and may never be!)
...
#endif
	SR3Error GetErrorReturn();

private:
	float mp_fSpectra[401];
	long BuildCommStruct();
	long SendGetCommand ( char *szOut, char *szIn, DWORD nTimeOutms, bool measure = false );
	...
	long GetMeasurementData(char *szResponse, short smaxlen, DWORD nTimeOutms);
	bool GetStatus();
